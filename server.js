...
// import MainSystemData from "./models/MainSystemData.js"; // import your model
...
//     origin: [
//       "http://localhost:3000",
//       "https://system-utiliy-frontend.onrender.com"
//     ],
//     // methods: ["GET", "POST"]
//   }
// });
...
// app.use(cors({ origin: "https://system-utiliy-frontend.onrender.com", credentials: true }));
...
//   // ------------------------------
//   const collection = mongoose.connection.collection("mainsystemdatas"); // exact collection name in MongoDB
...
//       io.emit("newMachine", newMachine); // send to frontend
//     }
